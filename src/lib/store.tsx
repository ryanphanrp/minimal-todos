...
interface TodoStore {
  ...
  addTodoAction: (prevState: TodoActionState, formData: FormData) => Promise<TodoActionState>;
...
export function TodoProvider({ children }: { children: ReactNode }) {
  ...
  const addTodoAction = async (prevState: TodoActionState, formData: FormData): Promise<TodoActionState> => {
    try {
  ...
  const updateTodoAction = async (id: number, text: string): Promise<TodoActionState> => {
    try {
      if (!text.trim()) {
